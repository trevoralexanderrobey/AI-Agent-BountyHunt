  ...
  const server = createHttpServer({
    ...
    supervisorOptions: {
      ...
      execution: {
        ...
        secretManifestPath: bootstrapIsProduction ? "" : process.env.SECRET_MANIFEST_PATH || "",
        secretManifestExpectedHash: process.env.SECRET_MANIFEST_EXPECTED_HASH || "",
      },
      security: {
        ...
        secretStoreProvider: process.env.SECRET_STORE_PROVIDER || "redis",
        secretStoreUrl: process.env.SECRET_STORE_URL || "",
        secretStorePrefix: process.env.SECRET_STORE_PREFIX || "openclaw:secrets",
        secretStoreConnectTimeoutMs: parsePositiveInt(process.env.SECRET_STORE_CONNECT_TIMEOUT_MS, 3000),
        secretFetchTimeoutMs: parsePositiveInt(process.env.SECRET_FETCH_TIMEOUT_MS, 3000),
        secretFetchMaxAttempts: parsePositiveInt(process.env.SECRET_FETCH_MAX_ATTEMPTS, 2),
        allowEnvSecretFallbackNonProd: parseBoolean(process.env.SECRET_FETCH_ALLOW_ENV_FALLBACK_NONPROD, false),
        secretLeakFailClosedInProduction: parseBoolean(process.env.SECRET_LEAK_FAIL_CLOSED_IN_PRODUCTION, true),
      },
      observability: {
